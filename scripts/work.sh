export CUDA_VISIBLE_DEVICES=3,5,6,9 ###
...
EXPERIMENT_NAME=${task}/from_base #with_generated_1
...
# python ./data_gen/${task}.py --local_dir $DATA_DIR    train_time_inferring_easy  train_time_reasoning_dynamic_alpha.parquet   test_time_reasoning_combined


python3 -m verl.trainer.main_ppo \
algorithm.adv_estimator=grpo \
data.train_files=$DATA_DIR/train_time_prediction_with_generated_1.parquet \
data.val_files=$DATA_DIR/small_test_time_prediction.parquet \
