...
def load_model_and_tokenizer(model_path):
    ...
    try:
        ...
        model = model.to("cuda:7")  # 显式地将模型移动到GPU上
        model.eval()  # 切换到评估模式
...
def main():
    ...
    output_file = "/data/zliu331/temporal_reasoning/TinyZero/preliminary/qwen3b_results/time_reasoning_qwen3b_results.jsonl"
    ...
    print(f"开始测试Qwen2.5-3B-Instruct模型在时间推理数据集上的表现")
