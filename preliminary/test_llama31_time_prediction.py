...
def load_model_and_tokenizer(model_path):
    ...
    try:
        ...
        model = model.to("cuda:0")  # 显式地将模型移动到GPU上，使用cuda:8
...
def main():
    ...
    output_file = "/mnt/data_from_server2/zliu331/temporal_reasoning/TinyZero/preliminary/llama31_results/time_prediction_llama31_results.jsonl"
    ...
    print(f"开始测试Llama-3.1-8B-Instruct模型在时间预测数据集上的表现")
