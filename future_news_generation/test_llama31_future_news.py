...
def load_model_and_tokenizer(model_path):
    ...
    try:
        ...
        # 解决Llama tokenizer没有padding token的问题
        ...
        model = model.to("cuda:8")  # 显式地将模型移动到GPU上，使用cuda:8
...
def main():
    ...
    output_file = "/mnt/data_from_server2/zliu331/temporal_reasoning/TinyZero/future_news_generation/llama31_results/future_news_llama31_results.jsonl"
    parsed_output_file = "/mnt/data_from_server2/zliu331/temporal_reasoning/TinyZero/future_news_generation/llama31_results/future_news_llama31_parsed.csv"
    ...
    print(f"开始测试Llama-3.1-8B-Instruct模型在未来新闻生成任务上的表现")
