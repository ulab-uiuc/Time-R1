...
class RayPPOTrainer(object):
    ...
    def __init__(self,
        ...
        # else:
        # self.is_main_process = True # Single process mode
    ...
    def _create_dataloader(self):
        ...
        # # Create a random generator with fixed seeds
        ...
        self.train_dataloader = DataLoader(dataset=self.train_dataset,
                                           ...
                                           shuffle=True,
                                        # generator=shuffle_generator, # Specify the generator for fixed seeds
                                           drop_last=True,
        ...
        # # Set the number of samples to be drawn
        # num_val_samples = 1024

        # # Get the index of all samples and use fixed seeds (optional) to ensure reproducibility
    ...
    def _save_checkpoint(self):
        # # Construct unique directory names using timestamps and global steps
        ...
        # # If necessary, make a similar unique name to the remote directory
            ...
            for batch_dict in self.train_dataloader:
                ...
                with _timer('step', timing_raw):
                    ...
                    with _timer('adv', timing_raw):
                        ...
                        # Add global steps to batch before calling reward_fn - Add here
